...
class PushNotificationSystem
{
  ...
  Future<String?> generateDeviceRegistrationToken() async //using these recognition token we can recognize each driver's device - used in receiving notification
  {
    String? deviceRecognitionToken = await firebaseCloudMessaging.getToken();//create the token and assign it to string type variable
  ...
  startListeningForNewNotification(BuildContext context) async
  {
    ...
    FirebaseMessaging.instance.getInitialMessage().then((RemoteMessage? messageRemote)//Remote message instance is used to get the data (here trip id)
    {
