...
class _HomePageState extends State<HomePage>
{
  ...
  goOnlineNow()
  {
    ...
    Geofire.initialize("onlineDrivers");// using geofire we set the driver location in the database
  ...
  setAndGetLocationUpdates()//To update the driver location every second in the database
  {
    positionStreamHomePage = Geolocator.getPositionStream().listen((Position position)
    {
      currentPositionOfDriver = position;

      if(isDriverAvailable == true)//checking whether the driver is online or not
      {
        Geofire.setLocation(
          FirebaseAuth.instance.currentUser!.uid,
          currentPositionOfDriver!.latitude,
                ...
                ElevatedButton(
                  onPressed: ()
                  {
                    showModalBottomSheet(
                        context: context,
                        isDismissible: false,//If this sheet is open you cannot close it
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  //Like a title
                                  Text(
                                    (!isDriverAvailable) ? "GO ONLINE NOW" : "GO OFFLINE NOW",//This is a boolean type variable
