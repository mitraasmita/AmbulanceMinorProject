...
class _NewTripPageState extends State<NewTripPage>
{
  ...
  makeMarker()
  {
    if(carMarkerIcon == null)
    {
      ...
      BitmapDescriptor.fromAssetImage(configuration, "assests/images/tracking.png")
          .then((valueIcon)
      {
  ...
  endTripNow() async
  {
    ...
    // for the record and not allowing the driver to 'end' the trip anywhere and not misuing this feature --- that is why destination location will be checked.
